...
import { UserModel } from './src/types.d.ts';
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  loginUser?: Resolver<ResolversTypes['UserResponse'], ParentType, ContextType, RequireFields<MutationLoginUserArgs, 'user'>>;
  registerUser?: Resolver<ResolversTypes['UserResponse'], ParentType, ContextType, RequireFields<MutationRegisterUserArgs, 'user'>>;
}>;
